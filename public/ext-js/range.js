...
function wmLayout_image(){
    ...
    document.getElementById("wmLayout1").innerHTML = `
        ...
        <label class="block mt-8 mb-2 font-poppins text-sm font-medium font-semibold text-slate-900 dark:text-white" for="wm_file_input">Upload Image file</label>
        ...
        <div class="mt-4">
            <label for="watermarkLayoutStyle" class="block mb-2 font-poppins text-sm font-medium text-gray-900 dark:text-white">Watermark Layer:</label>
        ...
        <div class="mt-4">
            <label for="watermarkPage" class="block mb-2 font-poppins text-sm font-medium text-gray-900 dark:text-white">Watermark pages:</label>
        ...
        <div class="mt-4">
            <label for="watermarkRotation" class="block mb-2 font-poppins text-sm font-medium text-gray-900 dark:text-white">Watermark Rotation:</label>
            <select id="watermarkRotation" name="watermarkRotation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option selected>Choose rotation degrees</option>
        ...
        <div class="mt-4">
            <label for="watermarkFontTransparency" id="TransparencyValue" class="block mb-2 font-poppins text-sm font-medium text-gray-900 dark:text-white">Watermark Transparency: </label>
