    ...
    <div class="grid grid-cols-1 grid-rows-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 p-4 mb-8">
        <div class="p-2 w-76 h-fit sm:mx-4 md:mx-4 md:mt-0 lg:mx-auto lg:ms-32 lg:h-auto lg:w-3/4 xl:w-fit xl:h-fit xl:mx-4 bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/compress">
                ...
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">Compress PDF</h5>
                    <p class="mb-3 font-normal text-gray-700">Reduce PDF file size while try to keep optimize for best PDF quality</p>
                </div>
            </a>
        </div>
        <div class="p-2 w-76 h-fit mt-6 sm:mt-0 sm:h-auto md:mt-0 md:h-100 lg:w-3/4 lg:h-auto lg:mx-auto lg:me-24 xl:w-fit xl:mx-4 xl:h-fit xl:mx-4 bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/merge">
                ...
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">Merge PDF</h5>
                    <p class="mb-3 font-normal text-gray-700">Combine several PDF in the order from user into one merged PDF file</p>
                </div>
            </a>
        </div>
        <div class="p-2 w-76 h-fit sm:mx-4 mt-6 md:mt-6 md:mx-4 lg:mt-6 lg:w-3/4 lg:h-auto lg:mx-auto lg:ms-32 xl:w-fit xl:mx-4 xl:mt-0 xl:h-auto 2xl:h-auto bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/split">
                <img class="rounded-t-lg mx-auto p-4" src="/assets/split.png" alt="" height="175px" width="175px" />
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">Split PDF</h5>
                    <p class="mb-3 font-normal text-gray-700">Separate one page or a whole page into independent PDF files</p>
                </div>
            </a>
        </div>
        <div class="p-2 w-76 h-fit mt-6 sm:h-100 md:h-auto md:mt-6 lg:mt-6 lg:w-3/4 lg:h-auto lg:mx-auto lg:me-24 xl:w-auto xl:mx-4 xl:h-auto xl:mt-0 xl:h-auto 2xl:h-fit bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/">
                ...
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">Watermark PDF</h5>
                    <p class="mb-3 font-normal text-gray-700">Stamp an text over PDF to selected pages or all pages</p>
                </div>
            </a>
        </div>
    </div>
    <h1 class="text-3xl font-poppins font-semibold tracking-tight leading-none text-gray-900 mt-10 ms-5 md:mt-10 md:ms-10 md:text-2xl lg:text-3xl dark:text-white">PDF Converter</h1>
    <div class="grid grid-cols-1 grid-rows-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 p-4 mb-8">
        <div class="p-2 w-76 h-fit mt-6 sm:mx-4 sm:mt-4 md:mx-4 lg:mt-6  lg:w-3/4 lg:h-auto lg:mx-auto lg:ms-32 xl:w-auto xl:h-fit xl:mx-4 bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/htmltopdf">
                ...
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">HTML To PDF</h5>
                    <p class="mb-3 font-normal text-gray-700">Convert URL address or web page into PDF format</p>
                </div>
            </a>
        </div>
        <div class="p-2 w-76 h-fit mt-6 sm:mt-4 sm:h-auto md:h-100 lg:mt-6 lg:w-3/4 lg:h-auto lg:mx-auto lg:me-24 xl:w-auto  xl:mx-4 xl:h-fit bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/pdftojpg">
                <img class="rounded-t-lg mx-auto p-4" src="/assets/picture.png" alt="" height="175px" width="175px" />
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">PDF To JPG</h5>
                    <p class="mb-3 font-normal text-gray-700">Convert PDF files into JPEG/JPG image format</p>
                </div>
            </a>
        </div>
        <div class="p-2 w-76 h-fit mt-6 sm:mx-4 sm:mt-4 sm:mb-4 md:mx-4 md:mb-16 md:h-auto lg:mt-6 lg:w-3/4 lg:h-auto lg:mx-auto lg:ms-32 xl:w-auto xl:mx-4 xl:h-fit bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/pdftoexcel">
                <img class="rounded-t-lg mx-auto p-4" src="/assets/xls.png" alt="" height="175px" width="175px" />
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">PDF To Excel</h5>
                    <p class="mb-3 font-normal text-gray-700">Convert PDF files into Excel spreadsheet</p>
                </div>
            </a>
        </div>
        <div class="p-2 w-76 h-fit mt-6 mb-4 sm:mt-4 md:h-auto md:mb-16 lg:mb-14 lg:mt-6 lg:w-3/4 lg:h-auto lg:mx-auto lg:me-24 xl:w-auto xl:mx-4 xl:h-fit bg-white border border-gray-200 rounded-lg shadow hover:transition hover:ease-in-out hover:delay-150 hover:scale-105 hover:transform-gpu hover:duration-300" type="button" data-ripple-dark="true">
            <a href="/pdftoword">
                <img class="rounded-t-lg mx-auto p-4" src="/assets/docx.png" alt="" height="175px" width="175px" />
                <div class="p-5">
                    <h5 class="mb-2 font-poppins font-semibold text-xl tracking-tight text-gray-900">PDF To Word</h5>
                    <p class="mb-3 font-normal text-gray-700">Convert PDF files into Word documents</p>
                </div>
            </a>
        </div>
    </div>
...
<footer class="fixed md:inline-flex bottom-0 left-0 z-20 w-full p-0 md:p-4 bg-slate-900 border-t border-text-slate-200 shadow md:flex md:items-center md:justify-between p-0 md:p-2">
