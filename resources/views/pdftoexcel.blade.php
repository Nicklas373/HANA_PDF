...
<head>
    ...
    <nav class="bg-slate-900 dark:bg-slate-800">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between p-4">
            ...
            <button data-collapse-toggle="navbar-dropdown" type="button" class="inline-flex items-center p-2 text-sm text-slate-200 rounded-lg max-[400px]:mt-2 md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-dropdown" aria-expanded="false">
...
<main>
    <form action="/pdftoexcel/xls" id="splitForm" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="p-4 lg:p-2 w-full md:w-2/5 mt-4 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    @if ($message = Session::get('success'))
                        ...
                        <div class="flex p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                            ...
                            <div class="ml-3 text-sm font-medium">
                                PDF To Excel Success !, Click <a href="{{ $message }}" class="font-poppins font-semibold underline hover:no-underline">Here </a>to download.
                            </div>
                        </div>
                    @elseif ($message = Session::get('error'))
                        ...
                        <div class="flex p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                            ...
                            <span class="sr-only">Info</span>
                            <div>
                                <span class="font-poppins font-medium">PDF To Excel Error ! </span> {{ $message }}
                            </div>
                        </div>
                    @elseif ($errors->any())
                        <br>
