...
<main>
    <form action="/pdftoword/docx" id="splitForm" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="p-4 lg:p-2 w-full md:w-2/5 mt-4 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    @if ($message = Session::get('success'))
                        ...
                        <div class="flex p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                            ...
                            <div class="ml-3 text-sm font-medium">
                                PDF To Word Success !, Click <a href="{{ $message }}" class="font-poppins font-semibold underline hover:no-underline">Here </a>to download.
                            </div>
                        </div>
                    @elseif ($message = Session::get('error'))
                        ...
                        <div class="flex p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                            ...
                            <span class="sr-only">Info</span>
                            <div>
                                <span class="font-poppins font-medium">PDF To Word Error ! </span> {{ $message }}
                            </div>
                        </div>
                    @elseif ($errors->any())
                        <br>
