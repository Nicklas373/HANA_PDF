...
<main>
    <form action="/watermark/pdf" id="splitForm" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <body class="bg-white dark:bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            <section>
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                    ...
                    <p class="mb-8 text-lg font-poppins font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Stamp an text over PDF to selected pages or all page</p>
                </div>
            </section>
                ...
                <div class="p-2 w-full md:w-2/5 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    @elseif ($message = Session::get('error'))
                        ...
                        <div class="flex p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                            ...
                            <span class="sr-only">Info</span>
                            <div>
                                <span class="font-poppins font-medium">Watermark PDF Error ! </span> {{ $message }}
                            </div>
                        </div>
                    @elseif ($errors->any())
                        <br>
                    ...
                    <div class="p-4 lg:p-2 w-full md:w-2/5 h-fit mx-auto mt-4 mb-8 lg:mb-8 xl:mb-0 bg-white border border-gray-200 rounded-lg shadow">
                        <div class="p-2 mx-auto">
                            <div>
                                <label for="watermarkText" class="block mb-2 font-poppins text-sm font-medium text-gray-900 dark:text-white">Text:</label>
                            ...
                            <div class="mt-4">
                                ...
                                <input id="watermarkFontTransparency" name="watermarkFontTransparency" type="range" min="0" max="100" value="0" step="20" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" oninput="showVal(this.value)" onchange="showVal(this.value)">
                            </div>
                        </div>
                    </div>
                    <button type="submit" id="submitBtn" class="mt-4 mb-12 md:mb-0 mx-auto font-poppins text-slate-200 bg-slate-900 rounded-lg cursor-pointer font-medium w-full h-16 sm:mb-12 md:w-2/5 md:h-16 md:mb-8 lg:w-1/5 lg:h-16" onClick="onClick()">Watermark PDF</button>
                </div>
            </div>
