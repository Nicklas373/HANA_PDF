    ...
    <nav class="bg-slate-900 dark:bg-slate-800">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between p-4">
            <a href="/" class="flex items-center">
                <span class="self-center text-2xl font-poppins font-semibold text-sky-400">Eureka</span>
                ''
                <span class="self-center text-2xl font-poppins font-semibold text-slate-200">PDF</span>
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto max-[1144px]:mt-4 xl:mt-0" id="navbar-dropdown">
    ...
    <form action="/watermark/pdf" method="POST" enctype="multipart/form-data">
        ...
        <body class="bg-white dark:bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            ...
            <div class="grid grid-rows-1 gap-2 p-4 mb-12 md:mb-0 xl:mb-12 2xl:mb-0" id="grid-layout">
                ...
                <div id="pdfCompLayout" class="p-4 lg:p-2 w-full md:w-2/5 h-fit mx-auto mt-4 mb-8 lg:mb-8 xl:mb-0 bg-white border border-gray-200 rounded-lg shadow" style="display: none;">
                    <div class="p-2 mx-auto">
                        <h3 class="font-poppins font-medium text-gray-900 dark:text-white">Watermark style :</h3>
                        <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-6 mt-4" role="group">
                            <button type="button" class="px-4 py-2 me-2 font-poppins font-medium text-slate-200 bg-slate-900 rounded-lg border border-blue-700 hover:bg-slate-200 hover:text-blue-700 focus:z-10 focus:ring-2 focus:bg-slate-200 focus:ring-slate-900 focus:text-slate-900" onClick="wmLayout_image()">
                                Image
                            </button>
                            <button type="button" class="px-4 py-2 me-2 font-poppins font-medium text-slate-200 bg-slate-900 rounded-lg border border-blue-700 hover:bg-slate-200 hover:text-blue-700 focus:z-10 focus:ring-2 focus:bg-slate-200 focus:ring-slate-900 focus:text-slate-900" onClick="wmLayout_text()">
                                Text
                            </button>
                        </div>
                        <div class="mt-4" id="wmLayout1" style="display:none;"></div>
                    </div>
                </div>
                <button type="submit" id="submitBtn" name="formAction" class="mt-4 mx-auto font-poppins text-slate-900 bg-slate-200 rounded-lg cursor-pointer font-medium w-full h-16 sm:mb-12 md:w-2/5 md:mb-8 lg:w-1/5 mb-2" onClick="onClick()" value="upload">Upload PDF</button>
                <div class="grid grid-cols-2 gap-4 p-4 mx-auto w-full h-24 sm:mb-12 md:w-2/5 md:mb-12 lg:w-1/5 mb-2" id="grid-layout_2" style="display: none;">
                    <button type="submit" id="submitBtn_2" name="formAction" class="mt-4 mx-auto font-poppins text-slate-900 bg-slate-200 rounded-lg cursor-pointer font-medium w-full h-full" onClick="onClick()" value="upload">Upload PDF</button>  
                    <button type="submit" id="submitBtn_3" name="formAction" class="mt-4 mx-auto font-poppins text-slate-200 bg-slate-900 rounded-lg cursor-pointer font-medium w-full h-full" onClick="onClick()" value="watermark">Watermark PDF</button>
                </div>
            </div>
