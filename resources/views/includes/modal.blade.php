    ...
    <div class="relative w-full max-w-2xl max-h-full">
        <div class="relative bg-pc4 rounded-lg shadow">
            <div class="p-6 space-y-6">
                ...
                <p id="errSubMessageModal" class="font-quicksand font text-dt3 text-sm leading-relaxed text-center">
...
<div id="versioningModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-xl max-h-full">
        ...
        <div class="flex flex-col items-center mt-5">
            <button data-modal-hide="versioningModal" type="button" class="text-white bg-pc mx-auto font-semibold font-quicksand rounded-md text-sm px-5 py-2.5 w-full" data-ripple-light="true">Close</button>
        </div>
    </div>
</div>
