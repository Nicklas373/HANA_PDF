<nav class="fixed left-0 top-0 z-10 w-full bg-slate-300 bg-opacity-50 backdrop-blur-md backdrop-filter">
    <div class="flex max-w-full flex-wrap items-center justify-between p-4">
      ...
      <div class="lg:order-0 mt-2 flex md:order-2 md:mt-0">
        <button type="button" class="font-poppins mr-3 rounded-lg bg-sky-700 px-4 py-2 text-center text-sm font-medium text-white hover:bg-sky-400 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:mr-0">Get Started</button>
      ...
      <div class="mt-2 hidden w-full items-center justify-between md:order-1 md:mb-2 md:mt-0 md:flex md:w-auto md:flex-1" id="navbar-cta">
        <ul class="mt-4 flex flex-col rounded-lg font-medium md:mt-0 md:flex-row md:space-x-8 md:border-0 md:p-0 md:px-4">
          ...
          <li>
            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" data-dropdown-placement="bottom" value="0" class="font-poppins flex w-full items-center justify-between rounded py-2 pl-3 pr-4 font-semibold text-slate-700 hover:text-slate-500 md:p-0" onClick="dropdownManage()">
              Convert
            ...
            <div id="dropdownNavbar" value="0" class="animate-fade inset-x-5 z-10 hidden h-auto w-auto transform-gpu rounded-lg bg-slate-300 font-normal shadow duration-500 md:w-32">
              <ul class="py-2 text-sm text-gray-700">
                <li>
                  <a href="/cnvToPDF">
                    <button id="cnvToPDFdropdown" type="button" class="font-poppins flex w-full items-center justify-between rounded py-2 pl-3 pr-4 font-semibold text-slate-700 hover:text-slate-500" onClick="dropdownCnvToPDF()">To PDF</button>
                  </a>
                </li>
                <li>
                  <a href="/cnvFromPDF">
                    <button id="cnvFromPDFdropdown" type="button" class="font-poppins flex w-full items-center justify-between rounded py-2 pl-3 pr-4 font-semibold text-slate-700 hover:text-slate-500" onClick="dropdownCnvFromPDF()">From PDF</button>
                  </a>
                </li>
                <li>
                  <a href="/htmltopdf">
                    <button id="cnvFromPDFdropdown" type="button" class="font-poppins flex w-full items-center justify-between rounded py-2 pl-3 pr-4 font-semibold text-slate-700 hover:text-slate-500" onClick="dropdownCnvFromPDF()">From HTML</button>
                  </a>
                </li>
              </ul>
            </div>
