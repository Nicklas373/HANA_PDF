    ...
    <div class="relative h-full overflow-hidden rounded-t-[40px] md:h-96 2xl:h-full shadow-[inset_0px_10px_25px_-10px_rgba(239,323,324,1)]">
            ...
            <div class="flex flex-row mx-auto items-center px-4 mt-14 md:mt-32 lg:mt-32 lg:ms-32 justify-center">
                ...
                <div class="mx-6 w-2/6 sm:w-3/6 md:w-2/6 lg:w-2/6 h-48 flex flex-col">
                    <div class="mt-8 lg:mt-0">
                        <h5 class="font-magistral font-semibold text-lg md:text-xl xl:text-3xl text-pc4">Compress</h5>
                    </div>
                    <div class="mt-2 mb-2 md:mt-4 md:mb-4">
                        <p class="font-quicksand font-normal text-xs lg:text-xl text-lt1">Create smaller PDF size while trying to keep optimized for quality.</p>
                    </div>
                    <div class="mt-4 lg:mt-2">
                        <button type="button" class="font-quicksand font-medium h-8 w-full lg:w-2/5 lg:h-10 rounded-lg bg-ac text-md lg:text-xl text-lt1" type="button" data-ripple-light="true" onclick="window.location.href='/compress'">Learn More</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="flex flex-row mx-auto items-center px-4 mt-14 md:mt-32 lg:mt-32 lg:ms-32 justify-center">
                ...
                <div class="mx-6 w-2/6 sm:w-3/6 md:w-2/6 lg:w-2/6 h-48 flex flex-col">
                    <div class="mt-8 lg:mt-0">
                        <h5 class="font-magistral font-semibold text-lg md:text-xl xl:text-3xl text-pc4">Converter</h5>
                    </div>
                    <div class="mt-2 mb-2 md:mt-4 md:mb-4">
                        <p class="font-quicksand font-normal text-xs lg:text-xl text-lt1">Convert PDF or document files to other format with our converter.</p>
                    </div>
                    <div class="mt-4 lg:mt-2">
                        <button type="button" class="font-quicksand font-medium h-8 w-full lg:w-2/5 lg:h-10 rounded-lg bg-ac text-md lg:text-xl text-lt1" type="button" data-ripple-light="true" onclick="window.location.href='/convert'">Learn More</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="flex flex-row mx-auto items-center px-4 mt-14 md:mt-32 lg:mt-32 lg:ms-32 justify-center">
                ...
                <div class="mx-6 w-2/6 sm:w-3/6 md:w-2/6 lg:w-2/6 h-48 flex flex-col">
                    <div class="mt-8 lg:mt-0">
                        <h5 class="font-magistral font-semibold text-lg md:text-xl xl:text-3xl text-pc4">Merge</h5>
                    </div>
                    <div class="mt-2 mb-2 md:mt-4 md:mb-4">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="flex flex-row mx-auto items-center px-4 mt-14 md:mt-32 lg:mt-32 lg:ms-32 justify-center">
                ...
                <div class="mx-6 w-2/6 sm:w-3/6 md:w-2/6 lg:w-2/6 h-48 flex flex-col">
                    <div class="mt-8 lg:mt-0">
                        <h5 class="font-magistral font-semibold text-lg md:text-xl xl:text-3xl text-pc4">Split</h5>
                    </div>
                    <div class="mt-2 mb-2 md:mt-4 md:mb-4">
                        <p class="font-quicksand font-normal text-xs lg:text-xl text-lt1">Split PDF file into separate, smaller and manage right in your choice.</p>
                    </div>
                    <div class="mt-4 lg:mt-2">
                        <button type="button" class="font-quicksand font-medium h-8 w-full lg:w-2/5 lg:h-10 rounded-lg bg-ac text-md lg:text-xl text-lt1" type="button" data-ripple-light="true" onclick="window.location.href='/split'">Learn More</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="flex flex-row mx-auto items-center px-4 mt-14 md:mt-32 lg:mt-32 lg:ms-32 justify-center">
                ...
                <div class="mx-6 w-2/6 sm:w-3/6 md:w-2/6 lg:w-2/6 h-48 flex flex-col">
                    <div class="mt-8 lg:mt-0">
                        <h5 class="font-magistral font-semibold text-lg md:text-xl xl:text-3xl text-pc4">Watermark</h5>
                    </div>
                    <div class="mt-2 mb-2 md:mt-4 md:mb-4">
