<div id="alert-scs" class="hidden p-4 mb-2 h-auto lg:h-6/6 bg-ac backdrop-filter backdrop-blur-md rounded-md bg-opacity-60" role="alert">
    ...
    <div class="flex">
        <button type="button" class="border-2 border-lt1 text-lt1 font-normal font-quicksand text-sm rounded-lg px-3 py-1.5 mr-2 text-center inline-flex items-center" data-ripple-light="true">
            <img class="ml-0.5 mr-2 h-3 w-3 -mt-1" src="{{ asset('assets/icons/download.svg') }}" alt="Downloads" />
            <b><a href="" id="scsMsgLink"></a></b>
        </button>
        <button type="button" class="bg-lt1 text-ac rounded-lg font-normal font-quicksand text-sm px-3 py-1.5 mr-2 text-center inline-flex items-center" data-dismiss-target="#alert-scs" aria-label="Close" data-ripple-light="true">
            <b>Dismiss</b>
        </button>
    </div>
</div>
<div id="alert-err" class="flex hidden p-4 mb-2 h-auto lg:h-36 bg-rt3 backdrop-filter backdrop-blur-md rounded-md bg-opacity-60" role="alert">
    ...
    <div>
        ...
        <br>
        <span id="errProcMain" class="text-xs text-lt1 font-normal font-quicksand"><b>Group ID:</b> <span id="errProcId"></span></span>
        <br>
