	...
	{{ csrf_field() }}
        <body class="bg-white dark:bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            ...
            <div class="grid grid-columns-3 gap-4 p-4 mx-auto mb-8" id="grid-layout">
                ...
                <div id="pdfCompLayout" class="p-4 lg:p-2 w-full md:w-2/5 mx-auto bg-white border border-gray-200 rounded-lg shadow" style="display: none;">
                    <h3 class="mb-5 font-poppins font-medium font-semibold text-slate-900 dark:text-white">Select compression quality</h3>
                ...
                <button type="submit" id="submitBtn_1" name="formAction" class="mt-8 max-[300px]:mb-12 mx-auto font-poppins text-slate-200 bg-slate-900 rounded-lg cursor-pointer font-medium w-full h-16 sm:mb-12 md:w-2/5 md:mb-8 lg:w-1/5 mb-2 text-center" onClick="onClick()" value="compress" style="display: none;">Compress PDF</button>
            </div>
