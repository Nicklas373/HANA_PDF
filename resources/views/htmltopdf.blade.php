        ...
        <body class="bg-white dark:bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            ...
            <div class="grid grid-rows-1 p-4" id="grid-layout">
                <div class="p-2 w-full md:w-2/5 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                    <label for="urlToPDF" class="block mb-2 font-poppins text-sm font-medium text-gray-900 dark:text-white">Write the website URL:</label>
                    ...
                    <button type="submit" id="submitBtn" class="mt-4 mb-12 md:mb-0 mx-auto font-poppins text-slate-200 bg-slate-900 rounded-lg cursor-pointer font-medium w-full h-16 sm:mb-12 md:w-2/5 md:h-16 md:mb-8 lg:w-1/5 lg:h-16" onClick="onClick()">Convert HTML</button>
                </div>
            </div>
