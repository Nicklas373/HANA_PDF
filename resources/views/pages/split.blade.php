                ...
                <div id="pdfPreview" name="pdfPreview">
                    ...
                    @if($message = Session::get('status'))
                        <?php
                            ...
                            $pdfTotalPages = session('pdfTotalPages');
                            echo '<input type="text" id="fileAlt" name="fileAlt" class="" placeholder="" style="display: none;" value="'.$pdfFileAppend.'">
                                <input type="text" id="maxPages" name="maxPages" class="" placeholder="" style="display: none;" value="'.$pdfTotalPages.'">
                                <div id="pdfImage" name="pdfImage" class="p-4 lg:p-2 w-full sm:w-5/5 md:w-4/5 lg:w-3/5 xl:w-2/5 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                                    ...
                                    <div class="text-center">
                                        <span id="caption" class="mt-2 mx-auto text-sm text-center text-slate-900 font-semibold" value="'.$pdfRealName.'" >'.$pdfRealName.' - '.$pdfTotalPages.' Pages</span>
                                    </div>
                                </div>
                            ';
                        ?>
