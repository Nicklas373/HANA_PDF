...
<div class="px-4 md:px-12">
   <section>
    <div class="py-8 px-4 mt-16 max-w-screen-xl mt-20 z-0">
        ...
        <p class="mb-4 text-lg font-poppins font-thin text-gray-500 lg:text-2xl">Meet the front-end and back-end technology to build this website</p>
    </div>
  </section>
  <div class="mx-4 mb-16 grid grid-cols-1 p-4 sm:grid-cols-2 md:mx-auto md:grid-cols-3 md:gap-2 xl:mx-auto xl:grid-cols-4 2xl:mb-12">
    <div class="mx-auto h-80 w-full rounded-lg bg-white bg-opacity-50 shadow-[inset_30px_30px_60px_-10px_rgba(255,255,255,1)] hover:shadow-[inset_-30px_-30px_60px_-10px_rgba(255,255,255,1)] hover:scale-105 hover:transform-gpu hover:transition hover:delay-150 hover:duration-300 hover:ease-in-out sm:mx-auto sm:w-72 md:h-96 md:w-64 lg:h-80 lg:w-72 2xl:w-96" type="button" data-ripple-dark="true">
      <a href="https://laravel.com/">
        ...
        <div class="p-4">
          ...
          <p class="font-poppins text-sm text-gray-700">
            Laravel Version:
            <span class="font-poppins mr-2 rounded bg-red-100 px-2.5 py-0.5 text-sm font-medium text-red-800 dark:bg-red-900 dark:text-red-300"><b><?php echo app()->version(); ?></b></span>
          </p>
        </div>
      </a>
    </div>
    <div class="mx-auto mt-6 h-80 w-full rounded-lg bg-white bg-opacity-50 shadow-[inset_30px_30px_60px_-10px_rgba(255,255,255,1)] hover:shadow-[inset_-30px_-30px_60px_-10px_rgba(255,255,255,1)] hover:scale-105 hover:transform-gpu hover:transition hover:delay-150 hover:duration-300 hover:ease-in-out sm:mx-auto sm:mt-0 sm:w-72 md:h-96 md:w-64 lg:h-80 lg:w-72 2xl:w-96" type="button" data-ripple-dark="true">
    ...
    <div class="mx-auto mt-6 h-80 w-full rounded-lg bg-white bg-opacity-50 shadow-[inset_30px_30px_60px_-10px_rgba(255,255,255,1)] hover:shadow-[inset_-30px_-30px_60px_-10px_rgba(255,255,255,1)] hover:scale-105 hover:transform-gpu hover:transition hover:delay-150 hover:duration-300 hover:ease-in-out sm:mx-auto sm:w-72 md:mt-0 md:h-96 md:w-64 lg:h-80 lg:w-72 2xl:w-96" type="button" data-ripple-dark="true">
      <a href="https://flowbite.com/">
        <img class="mx-auto mt-8 p-4 sm:mt-12" src="/assets/flowbite1.png" alt="" height="225px" width="215px" />
        <div class="p-4">
    ...
    <div class="mx-auto mt-6 h-80 w-full rounded-lg bg-white bg-opacity-50 shadow-[inset_30px_30px_60px_-10px_rgba(255,255,255,1)] hover:shadow-[inset_-30px_-30px_60px_-10px_rgba(255,255,255,1)] hover:scale-105 hover:transform-gpu hover:transition hover:delay-150 hover:duration-300 hover:ease-in-out sm:mx-auto sm:w-72 md:h-96 md:w-64 lg:mt-6 lg:h-80 lg:w-72 xl:mt-0 2xl:w-96" type="button" data-ripple-dark="true">
    ...
    <div class="mx-auto mt-6 h-80 w-full rounded-lg bg-white bg-opacity-50 shadow-[inset_30px_30px_60px_-10px_rgba(255,255,255,1)] hover:shadow-[inset_-30px_-30px_60px_-10px_rgba(255,255,255,1)] hover:scale-105 hover:transform-gpu hover:transition hover:delay-150 hover:duration-300 hover:ease-in-out sm:mx-auto sm:w-72 md:h-96 md:w-64 lg:mt-6 lg:h-80 lg:w-72 2xl:mt-6 2xl:w-96" type="button" data-ripple-dark="true">
      <a href="https://developer.ilovepdf.com/">
        <img class="mx-auto mt-4 p-4" src="/assets/ilovepdf1.png" alt="" height="125px" width="125px" />
        <div class="p-4">
      ...
      <a href="https://www.mysql.com/">
        ...
        <div class="p-4">
          ...
          <p class="font-poppins mt-8 text-sm text-gray-700 md:mt-16 lg:mt-12 xl:mt-12 2xl:mt-9">
            MySQL Version:
            <span class="mr-2 rounded bg-yellow-100 px-2.5 py-0.5 text-sm font-medium text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300"><b><?php echo mysqli_get_client_info(); ?></b></span>
          </p>
        </div>
      </a>
    </div>
