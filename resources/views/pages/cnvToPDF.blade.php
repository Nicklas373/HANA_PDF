    ...
    <div class="px-4 md:px-12" id="cnvToPDF">
        <section class="flex flex-wrap items-center justify-start sub-headline-viewport max-w-lg lg:max-w-6xl">
            <div class="text-start mx-6">
                <div class="font-magistral font-bold text-pc4 text-3xl lg:text-7xl mb-4 lg:mb-8">Convert to PDF</div>
                <div class="font-quicksand font-light text-md lg:text-3xl text-lt1">Convert document or image files into PDF documents.</div>
            </div>
        </section>
        <div class="flex flex-col p-2" id="dropzoneCnvToPDF">
            ...
            <div class="flex flex-col mx-4 mt-8 lg:w-3/6">
                <p class="block mb-2 font-quicksand text-xl font-bold text-pc4">Document Format</p>
                <div dir="ltl">
                    <button type="submit" id="submitBtn" name="formAction" class="mx-auto mt-2 lg:mt-4 mb-8 sm:mb-6 font-quicksand font-semibold bg-transparent border-2 border-lt backdrop-filter backdrop-blur-md rounded-lg bg-opacity-50 text-lt1 rounded-lg cursor-pointer w-full lg:w-4/6 h-10" data-ripple-light="true">Convert PDF</button>
                </div>
