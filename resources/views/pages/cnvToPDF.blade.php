...
@section('content')
    <div class="px-4 md:px-12" id="cnvToPDF">
        ...
        <form action="/convert/pdf" id="splitForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-columns-3 gap-4 p-4 mx-auto mb-8" id="grid-layout">
                <div class="grid md:grid-cols-2 gap-4 md:gap-20">
                    <div>
                        <label class="block mb-2 font-poppins text-base font-semibold text-slate-900">Upload Document file</label>
                    ...
                    <div>
                        <button type="submit" id="submitBtn" name="formAction" class="mx-auto mt-8 font-poppins font-semibold text-sky-400 border border-sky-400 rounded-lg cursor-pointer font-medium w-full h-10 sm:w-5/5 md:w-4/5 lg:w-3/5 xl:w-2/5 hover:bg-sky-400 hover:text-white" value="upload">Upload Document</button>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-20 mt-6">
                    ...
                    <div id="pdfCompLayout" class="mt-4" style="display: none;">
                        ...
                        <div dir="ltl">
                            <button type="submit" id="submitBtn_1" name="formAction" class="mx-auto mt-6 mb-8 sm:mb-6 font-poppins font-semibold text-white bg-sky-400 border border-sky-400 rounded-lg cursor-pointer font-medium w-full h-10 sm:w-5/5 md:w-4/5 lg:w-3/5 xl:w-2/5" value="convert" style="">Convert To PDF</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="/ext-js/iframe.js"></script>
