...
<div class="px-4 md:px-12">
  <section>
    <div class="z-0 mt-24 max-w-screen-xl px-4 py-8">
      <h1 class="font-poppins mb-4 text-4xl font-semibold leading-none tracking-tight text-sky-400 md:text-5xl lg:text-6xl">HTML To PDF</h1>
      <p class="font-poppins mb-4 text-lg font-thin text-gray-500 lg:text-2xl">Convert URL address or web page into PDF format</p>
    </div>
  </section>
