	...
	{{ csrf_field() }}
        <body class="bg-white dark:bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            ...
            <div class="grid grid-rows-1 gap-2 p-4 mb-8 md:mb-0 xl:mb-8 2xl:mb-0" id="grid-layout">
                ...
                <button type="submit" id="submitBtn" name="formAction" class="mt-4 mx-auto font-poppins text-slate-900 bg-slate-200 rounded-lg cursor-pointer font-medium w-full h-16 mb-4 md:w-2/5 lg:w-1/5 p-4 text-center" onClick="onClick()" value="upload">Upload PDF</button>
                <div id="splitLayout1" class="text-center rounded-md mb-8" role="group" style="display: none;">
                    <label class="block mb-4 font-poppins text-sm font-medium font-semibold text-slate-900 dark:text-white">Split Option</label>
