...
<main>
    <form action="/pdftojpg/image" id="splitForm" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <body class="bg-white dark:bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            <section>
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-0 relative">
                    <h1 class="mb-4 text-4xl font-poppins font-semibold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">PDF To JPG</h1>
                    <p class="mb-8 text-lg font-poppins font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Convert PDF files into JPEG/JPG image format</p>
                </div>
            </section>
            ...
            <div id="pdfPreview" name="pdfPreview">
                ...
                <div class="p-4 lg:p-2 w-full md:w-2/5 mt-4 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    @if ($message = Session::get('success'))
                        ...
                        <div class="flex p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                            ...
                            <div class="ml-3 text-sm font-medium">
                                PDF To JPG Success !, Click <a href="{{ $message }}" class="font-poppins font-semibold underline hover:no-underline">Here </a>to download.
                            </div>
                        </div>
                    @elseif ($message = Session::get('error'))
                        ...
                        <div class="flex p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                            ...
                            <span class="sr-only">Info</span>
                            <div>
                                <span class="font-poppins font-medium">PDF To JPG Error ! </span> {{ $message }}
                            </div>
                        </div>
                    @elseif ($errors->any())
                        <br>
                    ...
                    <button type="submit" id="submitBtn" name="formAction" class="mt-2 max-[300px]:mb-12 mx-auto font-poppins text-slate-900 bg-slate-200 rounded-lg cursor-pointer font-medium w-full h-16 sm:mb-12 md:w-2/5 md:mb-8 lg:w-1/5 mb-2" onClick="onClick()" value="upload">Upload PDF</button>
                    <div class="grid grid-cols-2 gap-4 p-4 mx-auto w-full h-24 sm:mb-12 md:w-2/5 md:mb-8 lg:w-1/5 mb-2" id="grid-layout_2" style="display: none;">
                        ...
                        <button type="submit" id="submitBtn_2" name="formAction" class="mt-4 mx-auto font-poppins text-slate-200 bg-slate-900 rounded-lg cursor-pointer font-medium w-full h-full" onClick="onClick()" value="convert">Convert PDF</button>
                    </div>
                </div>
            </div>
