    ...
    <form action="/merge/pdf" id="splitForm" method="POST" enctype="multipart/form-data">
        ...
        <body class="bg-white dark:bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            ...
            <div class="grid grid-rows-1 p-4" id="grid-layout">
                ...
                <button type="submit" id="submitBtn" class="mt-4 mx-auto font-poppins text-slate-200 bg-slate-900 rounded-lg cursor-pointer font-medium w-full h-16 sm:mb-12 md:w-2/5 md:h-16 md:mb-8 lg:w-1/5 lg:h-16" onClick="onClick()">Merge PDF</button>
            </div>
