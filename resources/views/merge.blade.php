        ...
        <body class="bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            ...
            <div class="grid grid-columns-3 gap-4 p-4 mx-auto mb-8" id="grid-layout">
                        ...
                        <br>
                            <?php
                                ...
                                foreach ($strToArr as $pdfFileName) {
                                    ...
                                    echo '
                                    <div id="pdfImage_'.$i.'" name="pdfImage" class="p-4 lg:p-2 w-full md:w-2/5 mb-8 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                                        <div class="text-left">
                ...
                <div class="p-2 w-full md:w-2/5 mx-auto bg-white border border-gray-200 rounded-lg shadow">
                    <label class="block mb-2 font-poppins text-sm font-medium font-semibold text-slate-900 dark:text-white" for="multiple_files">Upload PDF file</label>
                ...
                <button type="submit" id="submitBtn" name="formAction" class="mt-2 mx-auto font-poppins text-slate-900 bg-slate-200 rounded-lg cursor-pointer font-medium w-full h-16 sm:mb-12 md:w-2/5 md:mb-8 lg:w-1/5 mb-2" onClick="onClick()" value="upload" style="visibility: visible;">Upload PDF</button>
                <div class="grid grid-cols-2 gap-4 p-4 mx-auto w-full h-24 sm:mb-12 md:w-2/5 md:mb-8 lg:w-1/5 mb-2" id="grid-layout_2" style="display: none;">
                    ...
                    <button type="submit" id="submitBtn_2" name="formAction" class="mt-4 mx-auto font-poppins text-slate-200 bg-slate-900 rounded-lg cursor-pointer font-medium w-full h-full" onClick="onClick()" value="merge">Merge PDF</button>
                </div>
            </div>
